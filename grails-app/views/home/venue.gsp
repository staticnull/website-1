...
<section class="page-block">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <a href="${assetPath(src: 'venue/schulze-hall-location.89247f39.png')}"><asset:image class="img-responsive" src="venue/preview-schulze-hall-street.3f647e65.png"/></a>
                <a href="${assetPath(src: 'venue/schulze-hall-location.89247f39.png')}">Schulze Hall Street View</a><br>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-4">
